...
if __name__ == '__main__':
    ...
    file = open("one_min_raw_data.csv")
    ...
    print("Total Time (seconds): ", time_array[-1])
    ...
    graph_hist(x_accels, 'r', "Acceleration Over One Minute X-Axis (Standard Dev. = %.3f m/s/s)" % (x_sd), "x_hist_1_min_m_s_s.png", binsize=200)
    graph_hist(y_accels, 'b', "Acceleration Over One Minute Y-Axis (Standard Dev. = %.3f m/s/s)" % (y_sd), "y_hist_1_min_m_s_s.png", binsize=300)
    graph_hist(z_accels, 'g', "Acceleration Over One Minute Z-Axis (Standard Dev. = %.3f m/s/s)" % (z_sd), "z_hist_1_min_m_s_s.png", binsize=300)
